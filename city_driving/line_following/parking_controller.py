...
from line_following.msg import ConeLocation, ParkingError
...
class ParkingController():
    ...
    def __init__(self):
        ...
        DRIVE_TOPIC = rospy.get_param("~line_following_drive_topic") # set in launch file; different for simulator vs racecar
